...
<tr>
    ...
    <td class="tbdata"> <input id="total_prod<?php echo $value['id_tmp']?>" readonly class="form-control" type="text" name="total_prod[]" value="<?php echo $value['total'] ?>" placeholder="Total"></td>

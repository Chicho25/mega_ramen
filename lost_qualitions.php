<?php
    ...
    $perdidadeportclass ="class='active'";
    ...
    if(isset($_POST['name_proyect']) && $_POST['name_proyect'] != "")
    {
       ...
       $arrEntry = GetRecords("Select
                               ...
                               crm_entry inner join crm_customers on crm_entry.id_customer = crm_customers.id
                                         ...
                                         inner join master_stat on crm_entry.sub_stat = master_stat.id_stat
                                         $where"); ?>
	<section id="content">
          <section class="vbox">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped b-t b-light" data-ride="datatables">
                          ...
                          <tr>
                              ...
                              <td class="tbdata"> <?php echo $value['why_lost']?> </td>

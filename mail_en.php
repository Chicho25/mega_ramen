               ...
               $html .='<table width="100%" style="table-layout:fixed;">
                          <tr>
                            ...
                            <th style="text-align: center; background-color:#1e4799;" width="150">
                             <div style="border-radius:5px; color:white; width:100%;">PRICE</div>
                            </th>
                            <th style="text-align: center; background-color:#1e4799;">
                        ...
                        $html.='<tr>
                            <th style="text-align: left; width:200px;">WORK TO EXECUTE</th>
      ...
      $html .='<table width="100%" style="table-layout:fixed;">
                 <tr>
                  ...
                  $html .= '   <th style="text-align: center;">SERIAL</th>';
                   ...
                   $html .= '<th style="text-align: center; background-color:#1e4799;">
                    <div style=" border-radius:5px; color:white; width:100%;">TYPE</div>
                   </th>
                   <th style="text-align: center; background-color:#1e4799;" width="150">
                    <div style="border-radius:5px; color:white; width:100%;">PRICE</div>
                   </th>
             ...
             <div style="padding:3px;">
               <div style="border:2px solid black; border-radius:5px; float:left; width:350px; margin:3px;">
                 <table width="100%">
                   <tr>
                     <th>For the accounting purposes, the sending of the Purchase Order is required
                                               approved by the client</th>
                   </tr>
                   <tr>
               ...
               <div style="border:2px solid black; border-radius:5px; float:right; width:300px; margin:3px;">
                 <table width="100%">
                   <tr>
                     <th style="text-align: left;">TAXABLE SALES:</th>
                     <th style="text-align: left;">'.number_format($venta_gravable,2,".",",").' USD</th>
                   </tr>
                   <tr>
                     <th style="text-align: left;">TAXABLE NOT SALES:</th>
...
$subject = 'QUOTATION / GRUAS SHL: #'.$nomrbe_archivo.' PROYECT: '.$proyect_name;
...
$message .= "Dear Customer." .$eol;
$message .= "Receive a warm greeting from the GRUAS SHL team." .$eol;
$message .= "Enclosed I send the requested quote." .$eol;
$message .= "We look forward to your comments and confirmation," .$eol;
$message .= "If you have any questions or concerns, please contact Ms. Moira Chávez at the telephone number (507)231-6811/6866." .$eol;
$message .= "--".$separator.$eol;

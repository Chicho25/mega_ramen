<?php
    ...
    if(isset($_POST['save']))
     ...
     $arrQuol = GetRecords("Select
        ...
        $arrQuotCrate = GetRecords("select * from crm_quot where id_entry = '".$_GET['id']."' and stat = 5");
                	...
                	<form class="form-horizontal" data-validate="parsley" method="post" enctype="multipart/form-data">
                      ...
                      <section class="panel panel-default">
                        ...
                        <div class="panel-body">
                          ...
                          <?php include('include_product_approval.php'); ?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-3">
                                ...
                                <input id="total_coti" name="total" class="form-control" readonly value="<?php echo $total; ?>" style="margin:5px;" Width="70px" onkeyup="format(this)"/>
                              </div>
                            </div>
                          </div>
                          ...
                          function cargar(id, is_product, id_quot, id_entry){
                            $("#miselector").load("products_quolations_approval.php", { id: id,
                                                                                        ...
                                                                                        id_quot: id_quot,
                                                                                        id_entry: id_entry});
                            window.location.href = "approval_quot.php?id=" + id_entry;
                          }
                          </script>
                          <script language="javascript">
                        ...
                        <footer class="panel-footer text-right bg-light lter">
                          <?php if (isset($cotizacion_creada)): ?>
                          <button type="submit" name="send_quot" class="btn btn-success btn-s-xs glyphicon glyphicon-send"> Guardar Cotizacion</button>

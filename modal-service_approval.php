	      ...
	      <div class="row">
            ...
            <table class="table table-striped b-t b-light" data-ride="datatables">
              ...
              <tr>
                  ...
                  <td>
                    <button onclick="service(<?php echo $value['id']?>,1,<?php echo $_REQUEST['id_quot']?>,<?php echo $_REQUEST['id_entry']?>)" type="button" class="btn btn-icon btn-sm btn-primary glyphicon glyphicon-plus"/></button>
                  </td>
              </tr>
              <?php
              }

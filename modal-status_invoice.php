  ...
  <div class="modal-content">
  	<form role="form" class="form-horizontal" id="role-form"  method="post" action="" enctype="multipart/form-data">
	    <div class="modal-header">
	      ...
	      <h4 class="modal-title" style="color:red;">Pasar a Facturación </h4>
	    </div>
	    <div class="modal-body">
	      <div class="row">
		      <div class="form form-horizontal" style="padding:10px; margin:10px;">
            <p>El ingreso <b><?php echo $Entry[0]['number_tickets']; ?></b> Con todas sus cotizaciones se quitaran de la lista</p>
			    </div>
			  </div>
      </div>
	    <div class="modal-footer">
        <a href="#" class="btn btn-default" data-dismiss="modal">Cerrar</a>
        <button type="submit" name="billing" class="btn btn-primary">Ok</button>

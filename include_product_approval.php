...
<tr>
    ...
    <td class="tbdata"> <input id="total_prod<?php echo $value['id_tmp']?>" class="form-control" type="text" readonly name="total_prod[]" value="<?php echo $value['total'] ?>" placeholder="Total"></td>
    <td class="tbdata"> <a href="modal-delete-products.php?id_tmp=<?php echo $value['id_tmp']?>" title="Eliminar de la lista" data-toggle="ajaxModal" class="btn btn-sm btn-icon btn-danger"><i class="glyphicon glyphicon-trash"></i> </td>
</tr>
<tr>
